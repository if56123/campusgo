...
import com.campusgo.activity.type.CommondityInforLetaoActivity;
...
public class NewProMarketActivity extends CommonActivity implements
...
//		this.ProgressDialog();
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		intent.setClass(getApplicationContext(),
				CommondityInforLetaoActivity.class);
...
//			this.ProgressDialog();
			this.NewOrProAndHot(R.drawable.product_specialprice_image, "篮球鞋",
					12);
		}
	}
	...
	private void ProgressDialog() {
		...
		super.progressDialog = android.app.ProgressDialog.show(this, "校际购购物",
				"数据获取中....", true);
	...
	private void NewOrProAndHot(Object object, String type, int price) {
		...
		SimpleAdapter adapter = new SimpleAdapter(getApplicationContext(),
				mapsList, R.layout.common_gridview_text, new String[] {
						"Image", "text", "pro" }, new int[] { R.id.ItemImage,
						R.id.ItemText, R.id.proText });
