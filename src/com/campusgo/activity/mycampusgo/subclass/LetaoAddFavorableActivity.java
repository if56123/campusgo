package com.campusgo.activity.mycampusgo.subclass;
...
public class LetaoAddFavorableActivity extends CommonActivity implements
		OnClickListener {
	/**
	 * 添加
	 */
	...
	public void onClick(View v) {
		if (v == addTextView) {
			Toast toast = Toast.makeText(getApplicationContext(), "无效的优惠券号码!",
					Toast.LENGTH_SHORT);
