...
public class ReturnPasswordActivity extends CommonActivity implements
		OnClickListener {
	/**
	 * 找回密码
	 */
	...
	public void onClick(View v) {
		if (passwordEditText.getText().toString().length() < 11
			...
			Toast toast = Toast.makeText(this, "信息已经发送到您的手机上面,请注意查收!",
					Toast.LENGTH_SHORT);
			toast.setGravity(Gravity.CENTER, 0, 0);
			toast.show();
