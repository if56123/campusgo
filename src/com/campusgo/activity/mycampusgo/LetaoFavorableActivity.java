...
import com.campusgo.activity.mycampusgo.subclass.LetaoAddFavorableActivity;
import com.campusgo.activity.R;

public class LetaoFavorableActivity extends CommonActivity implements
		OnClickListener {
	/**
	 * 添加优惠券
	 */
	...
	public void onClick(View v) {
		startActivity(new Intent(getApplicationContext(),
				LetaoAddFavorableActivity.class));
	}
